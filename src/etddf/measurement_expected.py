...
def get_nonlinear_expected_meas(self, meas, x_hat, world_dim, num_ownship_states):
    if isinstance(meas, Azimuth_Explicit) or isinstance(meas, Azimuth_Implicit):
        ...
        other_x = x_hat[meas.measured_asset*num_ownship_states,0]
        other_y = x_hat[meas.measured_asset*num_ownship_states+1,0]
        ...
        if world_dim == 2:
            ...
            other_z = x_hat[meas.measured_asset*num_ownship_states+2,0]
