...
classdef ETKF < handle
    ...
    methods
        function obj = ETKF(F_,G_,H_,M_,Q_,R_,x0,P0,delta,agent_id,connections)
            obj.F = F_;
            obj.G = G_;
            obj.H = H_;
            obj.M = M_;
...
%         end
        ...
        function [transmit,types,data] = threshold(obj,meas)
            ...
            for i=1:length(meas)
                ...
                % with
                if strcmp(meas{i}.type,'abs') || (meas{i}.dest == obj.connection)
        ...
        function [x_curr,P_curr] = explicit_update(obj,meas_val,type,src_id)
        ...
        function [x_curr,P_curr] = implicit_update(obj,meas_val,type,i)
...
%             Kimplicit(:,i) = Kevent;
            x_curr = obj.x + K*zbar;
            invquant = obj.H(i,:)*obj.P*obj.H(i,:)' + obj.R(i,i);
